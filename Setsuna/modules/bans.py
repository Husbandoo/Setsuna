...
from Setsuna.modules.helper_funcs.extraction import extract_user_and_text
from Setsuna.modules.helper_funcs.string_handling import extract_time
from Setsuna.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        return log_message
    if user_id == bot.id:
        message.reply_text("Nyahhh!!!!... why do you want to ban me noob huh? ")
        return log_message
...
def temp_ban(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        return log_message
    if user_id == bot.id:
        message.reply_text("Nyah... I'm not gonna BAN myself, are you crazy?")
        return log_message
